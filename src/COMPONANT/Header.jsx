  ...
  return (
    <div>
      <div className="flex justify-center py-2 pt-5">
        <img src="https://i.ibb.co/pRF10Rj/asikbhai-removebg-preview.png" alt="Your Logo" className="w-32 rounded-full border-white border-2" />
      </div>
      <div className="w-2/3 relative mx-auto mt-2">
        <div className="absolute right-0 bottom-2 flex gap-3 text-white">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-700 font-serif">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
            </svg>
          </a>
          <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-600 border-2 rounded">
      ...
      <nav className="flex justify-center items-center gap-4 py-2">
        {['Home', 'About', 'Services', 'Products', 'Contact', 'FAQ'].map((item) => (
          <a
            key={item}
